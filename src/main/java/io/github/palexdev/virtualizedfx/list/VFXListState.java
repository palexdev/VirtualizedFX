...
/// Immutable object to represent the state of a [VFXList] in a specific moment in time. In other words, each and
...
///
/// **Note** that the data structure used to store the cells is particular, see [StateMap].
///
/// @see #INVALID
/// @see StateMap
...
public class VFXListState<T, C extends VFXCell<T>> {
    ...
    // Static Properties
    //================================================================================
    /// Special instance of `VFXListState` used to indicate that no cells can be present in the viewport at
    ...
    /// Retrieves the item at the given index from [VFXList#itemsProperty()] and delegates to
    /// [#addCell(int, Object, VFXCell)].
    ///
    /// @see StateMap
    ...
    /// Removes a cell from the [StateMap] for the given index. If the cell is not found, the next attempt
    /// is to remove it by the item at the given index in the [VFXList#itemsProperty()].
    ...
    /// @return the [VFXList] instance this state is associated to
