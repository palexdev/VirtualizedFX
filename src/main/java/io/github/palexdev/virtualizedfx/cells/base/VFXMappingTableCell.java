...
/// Extension of [VFXTableCell] to propose users a specific way of using [VFXTable].
...
/// @param <E> the data type the cell is going to use from items of type [T]
public interface VFXMappingTableCell<T, E> extends VFXTableCell<T> {
    ...
    /// @return the [StringConverter] used to convert an extracted value [E] to a `String`
