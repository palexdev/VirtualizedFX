...
public class VFXGrid<T, C extends VFXCell<T>> extends MFXControl
    ...
    /// @return the default function used to build a [VFXGridHelper].
    ...
    ///
    /// - the width and height bound to the grid's ones
    ///
    ...
    /// Delegate for [VFXGridState#getRowsRange()]
    ...
    /// Delegate for [VFXGridHelper#scrollToRow(int)], with parameter [Integer#MAX_VALUE].
    ...
    /// Delegate for [VFXGridHelper#scrollToColumn(int)], with parameter [Integer#MAX_VALUE].
    ...
    /// By default, the latter is computed as follows: `Math.ceil(nItems / nColumns)`.
    ///
    ...
    /// **Note** that 'baseline' positions are not supported and will default to [Pos#TOP_LEFT] instead.
    ///
