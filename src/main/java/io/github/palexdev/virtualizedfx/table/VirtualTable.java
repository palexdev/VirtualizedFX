...
public class VirtualTable<T> extends Control implements VirtualScrollPane.Wrappable {
    ...
    public void autosizeColumn(TableColumn<T, ? extends TableCell<T>> column) {
        ...
        When.onChanged(helper.layoutInitializedProperty())
            .condition((o, n) -> n)
            .then((o, n) -> helper.autosizeColumn(column))
            .oneShot(true)
            .executeNow(helper::isLayoutInitialized)
            .listen();
    }
    ...
    /**
     * Specifies an extra amount of pixel a column will have when it is auto-sized by the {@link TableHelper}.
     * <p>
     ...
     * when auto-sizing.
     * <p></p>
     * This is also settable via CSS with the "-fx-extra-autosize-width" property, by default is set to 10.0.
     */
    ...
    private static class StyleableProperties {
        ...
        private static final CssMetaData<VirtualTable<?>, Number> EXTRA_AUTOSIZE_WIDTH =
            FACTORY.createSizeCssMetaData(
                "-fx-extra-autosize-width",
                VirtualTable::extraAutosizeWidthProperty,
                10.0
            );
        ...
        static {
            cssMetaDataList = StyleUtils.cssMetaDataList(
                ...
                ENABLE_COLUMNS_CACHE, EXTRA_AUTOSIZE_WIDTH
            );
        }
    }
