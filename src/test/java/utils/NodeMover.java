...
public class NodeMover<T extends Node> {
    //================================================================================
    // Properties
    //================================================================================
    protected T node;
    ...
    private TriConsumer<T, Double, Double> moveHandler;
    ...
    public NodeMover(T node, TriConsumer<T, Double, Double> moveHandler) {
        this.node = node;
    ...
    // Getters/Setters
    //================================================================================
    public TriConsumer<T, Double, Double> getMoveHandler() {
        return moveHandler;
    }
