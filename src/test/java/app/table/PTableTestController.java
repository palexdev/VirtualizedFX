...
public class PTableTestController implements Initializable {
    ...
    StackPane rootPane;
    @FXML
    MFXFilterComboBox<PTableTestActions> actionsBox;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        MFXIconWrapper goFirst = IconWrapperBuilder.build()
                ...
                .addEventHandler(MouseEvent.MOUSE_CLICKED, event -> table.goToFirstPage()).get();
        ...
        MFXIconWrapper goBack = IconWrapperBuilder.build()
                ...
                .setSize(32)
                .enableRippleGenerator(true)
                .addEventHandler(MouseEvent.MOUSE_CLICKED, event -> table.setCurrentPage(Math.max(1, table.getCurrentPage() - 1))).get();
        ...
        MFXIconWrapper goForward = IconWrapperBuilder.build()
                ...
                .setSize(32)
                .enableRippleGenerator(true)
                .addEventHandler(MouseEvent.MOUSE_CLICKED, event -> table.setCurrentPage(table.getCurrentPage() + 1)).get();
        ...
        MFXIconWrapper goLast = IconWrapperBuilder.build()
                ...
                .setSize(32)
                .enableRippleGenerator(true)
                .addEventHandler(MouseEvent.MOUSE_CLICKED, event -> table.goToLastPage()).get();
